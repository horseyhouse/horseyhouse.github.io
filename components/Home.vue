<template>
    <div class="columns">
        ...
        <div>
            ...
            <ol>
                <a href="https://p2p.theias.place" target="_blank">
                    <li>
                        <img src="../media/torrenting.gif" alt="Torrenting" />
                        <img src="../media/pirate-flag.gif" alt="Torrenting" />
                    </li>
                </a>
                <a href="https://plex.theias.place" target="_blank">
                    <li>
                ...
                <a
                    href="https://drive.google.com/drive/folders/1X1ASnjqRPqbdrAG7p2Xe34t1mtIDAzK7"
                    target="_blank"
                >
                    <li>
